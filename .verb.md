# GitHub Base // Heads up

As of v1.0, the API is 100% promise based, callbacks are no longer supported. Please see the [API documentation](#api) and [release history]
